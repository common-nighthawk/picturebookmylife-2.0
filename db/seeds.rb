...
Book.create(title: 'Mom in BK', user_id: 1)
Book.create(title: 'Tim\'s Photos', user_id: 1)
Book.create(title: 'My Trip To Israel', user_id: 1)
Book.create(title: 'Life', user_id: 1)
Book.create(title: 'The Snail and the Elephant', user_id: 1)
Book.create(title: 'When We Were Young', user_id: 1)
Book.create(title: 'Life As We Know It', user_id: 1)
Book.create(title: 'Fortune', user_id: 1)
Book.create(title: 'Writers Retreat', user_id: 1)
Book.create(title: 'Fun in the Sun', user_id: 1)
...
Page.create(book_id: 3, position: 13, flickr_photo_id: '24303845471', text: "everyone who went in.")
Page.create(book_id: 3, position: 14, flickr_photo_id: '24360114996', text: "me. \n \n i don't actually have a six-pack, but because my hands are resting on my head it looks like i do. thats why this picture is included.")
